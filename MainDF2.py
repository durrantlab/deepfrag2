...
from apps.deepfrag.run_multimodal_model import MultimodalDeepFrag
...
if __name__ == "__main__":
    ...
    print("DeepFrag is using " + ("GPU" if torch.cuda.is_available() and not bool(args["cpu"]) else "CPU"))
    model.run(args)
