...
class DeepFragModel(pl.LightningModule):
    ...
    def add_model_args(parent_parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument('--fragment_representation', required=False, type=str, help="The type of molecular descriptors to be calculated: rdk10, rdkit_desc, maccs, morgan, molbert, molbert_pos, molbert_norm, molbert_norm2, molbert_x_rdk10, and molbert_x_morgan") # , default="rdk10")
