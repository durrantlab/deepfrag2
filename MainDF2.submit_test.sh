...
python MainDF2.py --csv /bgfs/jdurrant/durrantj/deepfrags/deepfrag2_post_cesar/data/moad/every.csv --data /bgfs/jdurrant/durrantj/deepfrags/deepfrag2_post_cesar/data/moad/BindingMOAD_2020/ --load_splits /ihome/jdurrant/crg93/output_deepfrag/splits.json --default_root_dir /ihome/jdurrant/crg93/output_deepfrag --mode test --inference_rotations 8 --aggregation_rotations ${params[${SLURM_ARRAY_TASK_ID}]} --load_newest_checkpoint True
