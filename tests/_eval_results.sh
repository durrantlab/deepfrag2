...
test_file_exists ./11.train_on_moad_molbert.output/last.ckpt
test_file_exists ./12.test_moad_trained_molbert.output/predictions_MOAD/mean/test_results-1.json
test_file_exists ./13.finetune_custom_download.output/last.ckpt
