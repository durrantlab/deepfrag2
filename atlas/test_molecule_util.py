...
class TestMoleculeUtil(unittest.TestCase):
    ...
    def test_aspirin_simple(self):
        ...
        self.assertEqual(m.atom_types.shape, (13,1))
        self.assertEqual(m.bond_index.shape, (13,2))
        self.assertEqual(m.bond_types.shape, (13,1))

    def test_aspirin_undirected(self):
        smiles = 'CC(=O)OC1=CC=CC=C1C(=O)O' # Aspirin
        m = MolGraph.from_smiles(smiles)
        ...
        self.assertEqual(m.bond_index.shape, (26,2))
        self.assertEqual(m.bond_types.shape, (26,1))
    ...
    def test_azythromycin_simple(self):
        ...
        self.assertEqual(m.atom_types.shape, (52,1))
        self.assertEqual(m.bond_index.shape, (54,2))
        self.assertEqual(m.bond_types.shape, (54,1))
