...
def main():
    ...
    parser.add_argument('dense_gcn_model', 
        help='Path to pretrained DenseGraphAutoencoder model')
    parser.add_argument('csv_out', help='Path to out.csv')
    parser.add_argument('--num', default=50000, type=int, 
        help='Number of fragments to use.')
    parser.add_argument('--pca_embedding_size', default=50, 
